...
namespace FastGeoMesh.Tests
{
    ...
    public sealed class IntelligentCachePerformanceTests
    {
        ...
        [Fact]
        public void IntelligentCache_ShowsMajorPerformanceGains()
        {
            // Arrange
            ...
            collectionAccessTime.TotalMicroseconds.Should().BeLessThan(4000, 
                "Cached collection access should be reasonably fast");
            
            countAccessTime.TotalMicroseconds.Should().BeLessThan(4000, 
            ...
            accessesPerMicrosecond.Should().BeGreaterThan(3, "Cache should enable reasonable access rates");
        }

        [Fact]
        public void IntelligentCache_PerCollectionInvalidation()
        {
            // Arrange
            ...
            selectiveInvalidationTime.TotalMicroseconds.Should().BeLessThan(5000, 
                "Selective invalidation should maintain good performance");
        }

        [Fact]
        public void SpanAPI_ZeroAllocationBulkOperations()
        {
            // Arrange
            ...
            spanBulkTime.TotalMicroseconds.Should().BeLessThan(2000, "Span operations should be reasonably fast");
            enumerableBulkTime.TotalMicroseconds.Should().BeLessThan(2000, "IEnumerable operations should be reasonably fast");
        }
