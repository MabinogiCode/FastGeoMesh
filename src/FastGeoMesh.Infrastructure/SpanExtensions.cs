...
namespace FastGeoMesh.Infrastructure
{
    ...
    public static class SpanExtensions
    {
        ...
        /// <returns>Centroid position.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FastGeoMesh.Domain.Vec3 ComputeCentroid(this ReadOnlySpan<FastGeoMesh.Domain.Vec3> vertices)
        {
            if (vertices.IsEmpty)
            {
                return FastGeoMesh.Domain.Vec3.Zero;
            }
            ...
            double count = vertices.Length;
            return new FastGeoMesh.Domain.Vec3(sumX / count, sumY / count, sumZ / count);
        }
        ...
        public static void TransformTo3D(this ReadOnlySpan<Vec2> source, Span<FastGeoMesh.Domain.Vec3> destination, double z)
        {
            ...
            {
                var v2 = source[i];
                destination[i] = new FastGeoMesh.Domain.Vec3(v2.X, v2.Y, z);
            }
        }
