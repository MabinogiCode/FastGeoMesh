namespace FastGeoMesh.Domain {
    ...
    public class Result<TValue> : Result {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Result{TValue}"/> class representing success.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Result{TValue}"/> class representing failure.
        /// </summary>
        ...
        /// </summary>
        /// <param name="error">The error associated with the failure.</param>
        /// <returns>A failed <see cref="Result{TValue}"/> representing the error.</returns>
